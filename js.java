...
function generateSadPoem(event){
    ...
    let context="please generate a sad poem following the prompt. use basic HTMl. Let the first 3 words be the topic of the poem inside a <strong>. Let poem be so sad. let Use <br/> after every comma or fullstop. The poem should be in English and short";
